...
function SearchBar({setFunctions}) {
    ...
    useEffect(() => {
        async function getLanguages() {
            const response = await fetch('https://hubfunctions.com/api/programming_languages/get/');
    ...
    async function handleSubmit(event){
        ...
        const response = await fetch('https://hubfunctions.com/api/functions/search/?search_term=' + searchTerm + "&programming_languages=" + JSON.stringify(selectedOptions), {
            method: 'GET',
            headers: {
